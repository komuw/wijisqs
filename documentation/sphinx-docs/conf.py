...
html_theme_options = {
    "description": "wijisqs is an async blah blash.",
    "github_banner": False,
...
latex_documents = [(master_doc, "wijisqs.tex", "wijisqs Documentation", "Komu Wairagu", "manual")]
...
man_pages = [(master_doc, "wijisqs", "wijisqs Documentation", [author], 1)]
